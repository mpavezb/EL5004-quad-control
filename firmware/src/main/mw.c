...
void loop(void)
{
    ...
    if (masterConfig.looptime == 0 || (int32_t)(currentTime - loopTime) >= 0) {
        ...
        pwmWriteMotor(1, 65000);
        pwmWriteMotor(2, 65000);
        pwmWriteMotor(3, 65000);
        pwmWriteMotor(4, 65000);
        pwmWriteMotor(5, 65000);
        pwmWriteMotor(6, 65000);
        pwmWriteMotor(7, 65000);
        pwmWriteMotor(8, 65000);
        pwmWriteMotor(9, 65000);
        pwmWriteMotor(10, 65000);
        pwmWriteMotor(11, 65000);
        pwmWriteMotor(12, 65000);
